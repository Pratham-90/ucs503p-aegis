...
\author{
  Pratham Arora, COE%
  \thanks{Roll No: \texttt{1024030001}, %
    Email: \texttt{parora\_be24@thapar.edu}}
}
...
acceptance authority) and the author (as the sole developer). Each functional
...
\begin{itemize}[leftmargin=0.7cm]
  ...
  \item \textbf{Process:} the system is developed solo over a 12-week UCS503P
