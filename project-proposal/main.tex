...
\begin{description}[leftmargin=0cm,style=nextline]
  ...
  \item[\ReqID{FR-4} Trustee designation, enrolment \& threshold.] The Owner
    ...
    $1 \le K \le N$. Each designated trustee shall enrol a \emph{public key}
    ...
    split (\ReqID{FR-2a}); the key is therefore never split or held server-side.
